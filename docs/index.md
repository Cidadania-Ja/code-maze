...
Assumiremos que você enxerga o estado do projeto entregue como ideal. Ou seja, se você deixar algo no código que você não goste mas não teve tempo de mexer ou fazer diferente, vale registrar isso por escrito. Assim, conseguiremos ter um entendimento maior sobre como você enxerga esse determinado assunto.
